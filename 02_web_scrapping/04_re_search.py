...
m = p.search("good care") # search : 주어진 문자열 중에 일치하는게 있는지 확인 -> good care에 "ca.e"가 있으니까 있다고 판단
print_search(m)

m = p.search("careless") # search : 주어진 문자열 중에 일치하는게 있는지 확인 -> good care에 "ca.e"가 있으니까 있다고 판단
print_search(m)
